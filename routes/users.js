    ...
    function insertData(tempObject) {
      ...
      var data = {
        ...
        html: `<html><h1>You've created a new poll!</h1><h2>${pollname}</h2>
          <p>Congratulations ${req.body.firstname}! Your new poll has been created and is ready for voting!
          <p>To view your poll, <a href="http://127.0.0.1:8080/${adminURL}" target="_blank">click here</a>.</p>
          <p>To share your poll with friends, copy and paste the Share Link to emails, social media, a billboard, etc.</p>
